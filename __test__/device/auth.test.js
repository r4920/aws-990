...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Hattie67',
      password: 'sFEa6x1M6ygS13s',
      email: 'Minnie_Kuphal80@hotmail.com',
      name: 'Ms. Roman Kertzmann',
      userType: 45,
      mobileNo: '855-793-5735 x114',
      resetPasswordLink: {},
      loginRetryLimit: 977,
      loginReactiveTime: '2022-10-04T03:32:11.487Z',
      id: '62416aa9313633084d9d16ea'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Zoie_Smitham83',
        'password':'MJZHv1kqAjiYcZW',
        'email':'Adela_Thiel43@yahoo.com',
        'name':'Mercedes Parisian',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(742) 347-7609 x9036',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Adela_Thiel43@yahoo.com', });
